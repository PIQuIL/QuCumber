...
However for real wavefunctions for mixed sign, or more generally complex wavefunctions, the phase information contained in these coefficients will be lost if the measurement
...
QuCumber also provides the possibility to do state reconstruction for complex wavefunctions.
...
We thank G. Carleo, J. Carrasquilla,  L. Hayward Sierens, and J. Matlock for stimulating discussions.
