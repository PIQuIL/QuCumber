...
\subsection{An analytical example for QST}
...
The state \verb|target_psi| is a random complex state and is fully described on the tutorial of the 2-qubit example \url{https://github.com/PIQuIL/QuCumber/blob/develop/examples/02_qubits/tutorial_qubits.ipynb}.
