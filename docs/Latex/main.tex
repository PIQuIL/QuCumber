...
{\bf
        ...
        In this paper, we present an open-source software package called QuCumber which uses machine learning to effectively reconstruct the most likely quantum state consistent with a set of projective measurements.
        QuCumber can be used to study traditionally challenging physical properties, not directly accessible in current experiments such as the entanglement entropy. 
}
