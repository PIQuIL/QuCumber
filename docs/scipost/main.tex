...
atoms~\cite{gambetta17,gambetta18,Bernien17,ion53}, reliable and scalable
...
and in other contexts in quantum many-body physics~\cite{PhysRevB.96.205152,SteveW}.
...
unitary_dict = unitaries.create_dict(U=U)
\end{python}
where \verb|re_part| and \verb|im_part|, are to be specified by the user.
...
\bibliography{bib/RBMs,bib/RGandDL,bib/TNandDL,bib/MLtomography,bib/RBMphysics,bib/bibliography,bib/representationsDL}
\nolinenumbers{}
\end{document}
