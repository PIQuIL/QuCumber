...
can be found in References \cite{torlai_learning_2016} and \cite{torlai_neural-network_2018}.
...
\begin{equation}\label{wfpd}
    ...
    \simeq\Psi(\x)\:.
\end{equation}
The precise mathematical form of the marginal distribution $p_{\bm{\lambda}}(\x)$ defined in terms of an effective energy
