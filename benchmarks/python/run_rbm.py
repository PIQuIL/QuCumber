...
@click.option('--method', default='sgd', show_default=True,
              type=click.Choice(["nesterov", "momentum", "sgd", "adam"]),
              help="the optimization method to use")
def train(train_path, target_path, save, num_hidden, epochs, batch_size,
    ...
    nll_list, overlap_list = rbm.train(train_set, target_psi, epochs,
                                       batch_size, k=k,
