...
system_size    data/path   batch_size  epochs  hidden_units    learning_rate   momentum    gpu_usage(0= False / 1 = True)
"""
...
if len(sys.argv) != 9:
    sys.exit('arguments missing! 1. system size, 2. batch_size, 3. epochs, 4. hidden_units, 5. k, 6. learning rate, 7. momentum, 8. gpu (0 / 1)')
L = int(sys.argv[1])
