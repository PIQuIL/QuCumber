...
@click.option('-nb', '--neg-batch-size', default=200, show_default=True, type=int)
...
def train_complex(train_path, basis_path, true_psi_path, num_hidden_amp, 
				  num_hidden_phase, epochs, batch_size, k, learning_rate, log_every, seed, 
				  test_grads, no_prog):
	...
	rbm.fit(train_set, basis_set, unitary_dict, epochs, batch_size, k=k, lr=learning_rate, log_every=log_every, progbar=(not no_prog))
