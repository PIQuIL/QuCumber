...
def trainEnergy(numQubits,
    ...
    elif model == "TFIM1D0p65":
        modelEnergy = TFIMChainEnergy(0.65)
    elif model == "TFIM1D0p7":
        modelEnergy = TFIMChainEnergy(0.7)
    elif model == "TFIM1D0p75":
        modelEnergy = TFIMChainEnergy(0.75)
    elif model == "TFIM1D0p8":
        modelEnergy = TFIMChainEnergy(0.8)
    elif model == "TFIM1D0p85":
        modelEnergy = TFIMChainEnergy(0.85)
    elif model == "TFIM1D0p9":
        modelEnergy = TFIMChainEnergy(0.9)
    elif model == "TFIM1D0p95":
        modelEnergy = TFIMChainEnergy(0.95)
    ...
    elif model == "TFIM1D12p0":
        modelEnergy = TFIMChainEnergy(12.0)
